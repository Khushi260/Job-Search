import simple from '../../Assests/simple.jpeg'
  ...
  return (
    <div className="mb-[4rem] mt-[6rem]">
      ...
      <div className="grid gap-[10rem] grid-cols-3 items-center">
        ...
        <div className="singleGrid rounded-[10px] hover:bg-[#eeefd7] p-[1.5rem]">
        ...
        <div className="singleGrid rounded-[10px] hover:bg-[#eeefd7] p-[1.5rem]">
          ...
          <p className='text-[15px] text-textColor opacity-[.7] py-[1rem] font-semibold'>
            Acting with honesty, ethics, and transparency in all business dealings.
          </p>
        </div>
        ...
        <div className="singleGrid rounded-[10px] hover:bg-[#eeefd7] p-[1.5rem]">
          ...
          <p className='text-[15px] text-textColor opacity-[.7] py-[1rem] font-semibold'>
            Embracing creativity and continuous improvement to stay ahead in a dynamic marketplace.
          </p>
        </div>
      ...
      <div className="card mt-[2rem] flex justify-between bg-blueColor p-[5rem] rounded-[10px]">
        ...
        <button className='border-[2px] rounded-[10px] py-[4px] px-[50px] text-[18px] font-semibold text-blueColor hover:bg-blueColor border-blueColor hover:text-teal-50'>
          Get Started
        </button>
      </div>
